meta = {
    ...
    version = '2.0',
    description = 'Spelunker Trials, too.',
    author = 'JawnGC',
}
...
--Set level order
levels = {dwelling1, dwelling2, dwelling3, dwelling4, volcana1, volcana2, volcana3, volcana4, jungle1, jungle2, jungle3, jungle4, tidepool1, tidepool2, tidepool3, tidepool4, temple1, temple2, temple3, temple4, neobabylon1, neobabylon2, neobabylon3, neobabylon4, sunkencity1, sunkencity2, sunkencity3, sunkencity4, ending}
...
set_callback(function()
	...
	elseif level_sequence.get_run_state().current_level.identifier == "Volcana-4" then
		state.level_flags = set_flag(state.level_flags, 18)
	elseif level_sequence.get_run_state().current_level.identifier == "Temple-4" then
		state.level_flags = set_flag(state.level_flags, 18)
	else	
		state.level_flags = clr_flag(state.level_flags, 18)
	end	
